...
neverConsumers = function(zz, mmi, X_cols, Food_col, Energy_col, ID_col, FFQ_food_col,
  ...
  ###########################################################################
  alpha_postmean      <-  apply(alpha_thin_trace,1, mean)
  ...
  alpha_postsd        <- apply(alpha_thin_trace, 1, sd)
  ...
  alpha_ci            <- apply(alpha_thin_trace, 1, function(x) quantile(x, c(0.025, 0.975)))
